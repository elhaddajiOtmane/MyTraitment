...
if ($nextPost || $prevPost) :
    ...
    echo '<section class="cleenday-post-navigation">';
    ...
    if (is_a($prevPost, 'WP_Post')) :
        ...
        echo '<div class="prev-link_wrapper">',
            ...
            '<a href="', esc_url(get_permalink($prevPost->ID)), '" title="', esc_attr($prevPost->post_title), '">',
                ...
                ( $prevPost->post_title ? '<h4 class="prev_title">' . wp_kses($prevPost->post_title, $allowed_html) . '</h4>' : '' ),
    ...
    if (is_a($nextPost, 'WP_Post') ) :
        ...
        echo '<div class="next-link_wrapper">',
            ...
            '<a href="', esc_url(get_permalink($nextPost->ID)), '" title="', esc_attr($nextPost->post_title), '">',
                ...
                ( $nextPost->post_title ? '<h4 class="next_title">' . wp_kses($nextPost->post_title, $allowed_html) . '</h4>' : '' ),
                '<span class="meta-data">',
                    '<span class="date_post">',
    ...
    if (is_a($prevPost, 'WP_Post')
        ...
        echo '<a class="back-nav_page"',
            ' title="', esc_attr__('Back to previous page', 'cleenday'), '"',
    ...
    echo '</section>'; // cleenday-post-navigation
