        ...
        private function is_minimum_version () {
            ...
            if ($this->min_redux_version != '') {
                if (version_compare($redux_ver, $this->min_redux_version) < 0) {
                    $msg = '<strong>' . esc_html__( 'The', 'cleenday-core') . ' ' .  $this->ext_name . ' ' .  esc_html__('extension requires', 'cleenday-core') . ' Redux Framework ' . esc_html__('version', 'cleenday-core') . ' ' . $this->min_redux_version . ' ' .  esc_html__('or higher.','cleenday-core' ) . '</strong>&nbsp;&nbsp;' . esc_html__( 'You are currently running', 'cleenday-core') . ' Redux Framework ' . esc_html__('version','cleenday-core' ) . ' ' . $redux_ver . '.<br/><br/>' . esc_html__('This field will not render in your option panel, and featuress of this extension will not be available until the latest version of','cleenday-core' ) . ' Redux Framework ' . esc_html__('has been installed.','cleenday-core' );
